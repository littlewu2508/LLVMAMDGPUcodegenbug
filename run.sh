...
clang -cc1 -emit-obj -triple amdgcn-amd-amdhsa -target-cpu ${AMDGPU_ARCH} source1.cl -o GPUkernel1.o
clang -cc1 -emit-obj -triple amdgcn-amd-amdhsa -target-cpu ${AMDGPU_ARCH} source2.cl -o GPUkernel2.o
